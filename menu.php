	...
	<link rel="stylesheet" href="css/mobile_index_style.css"> 
...
?>
    ...
    <div class="mainContainer flex col-1-1"> 
        <div class="containerHero flex col-1-1">
            <div class="hero col-1-1">
                <nav class="flex col-1-1">
